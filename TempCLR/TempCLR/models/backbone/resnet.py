...
def resnet18(pretrained=False, freeze=False, **kwargs):
    ...
    Args:
        ...
        freeze (bool): If True, freeze the weights of the network
    """
    ...
    if pretrained:
        ...
        model.load_state_dict(model_zoo.load_url(model_urls['resnet18']),
                              strict=False)
    if freeze:
        logger.info("Freeze ResNet-18 parameters")
...
def resnet34(pretrained=False, freeze=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(model_zoo.load_url(model_urls['resnet34']),
                              strict=False)
    if freeze:
        logger.info("Freeze ResNet-34 parameters")
        for param in model.parameters():
            param.requires_grad = False
...
def resnet50(pretrained=False, freeze=False, **kwargs):
    ...
    if freeze:
        logger.info("Freeze ResNet-50 parameters")
        for param in model.parameters():
            param.requires_grad = False
...
def resnet101(pretrained=False, freeze=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(model_zoo.load_url(model_urls['resnet101']),
                              strict=False)
    if freeze:
        logger.info("Freeze ResNet-101 parameters")
        for param in model.parameters():
            param.requires_grad = False
...
def resnet152(pretrained=False, freeze=False, **kwargs):
    ...
    if freeze:
        logger.info("Freeze ResNet-152 parameters")
        for param in model.parameters():
            param.requires_grad = False
